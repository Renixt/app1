...
Finalmente, se implementó una funcionalidad de búsqueda, que permite filtrar la lista de personajes conforme el usuario escribe en el buscador, mostrando únicamente los resultados coincidentes.
